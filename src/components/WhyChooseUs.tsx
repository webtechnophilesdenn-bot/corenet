  ...
  return (
    <section ref={sectionRef} className="bg-gradient-to-b from-slate-50 via-white to-blue-50 py-12 min-h-screen flex items-center">
      <div className="container mx-auto px-4">
        ...
        {/* Process Timeline - MOVED BELOW BOTH GRIDS - FULL WIDTH */}
        <div className={`w-screen bg-gradient-to-br from-gray-50 to-white border-y border-gray-200 py-6  mt-12 transition-all duration-700 delay-300 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
        }`} 
        style={{
          position: 'relative',

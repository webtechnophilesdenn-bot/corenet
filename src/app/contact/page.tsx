...
export default function ContactPage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <section className="bg-white py-8 md:py-12 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          ...
          <div
            className="absolute bottom-20 right-20 w-96 h-96 bg-indigo-100 rounded-full blur-3xl animate-pulse"
  ...
  <div className="bg-white/90 backdrop-blur-md rounded-2xl p-6 border border-gray-200/50 shadow-xl hover:bg-white hover:border-gray-300 transition-all duration-300 h-full flex flex-col justify-center">
        ...
        <div className="container mx-auto px-4 max-w-8xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            {[
              ...
              <div
                key={i}
                className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-6 text-center border-2 border-gray-100 hover:border-blue-200 transition-all hover:shadow-xl group"
              >
                <div
                  className={`w-14 h-14 bg-gradient-to-br ${item.gradient} rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:scale-110 transition-transform`}
                >
                  <svg
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              href="tel:+919028501604"
              className="bg-white text-blue-600 px-8 py-4 rounded-xl font-bold hover:bg-gray-100 transition-all shadow-xl hover:shadow-2xl transform hover:-translate-y-1 flex items-center justify-center gap-2"
            >
              <svg
                className="w-5 h-5"
                fill="none"
            ...
            <a
              href="mailto:sales@corenet.co.in"
              className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-xl font-bold hover:bg-white hover:text-blue-600 transition-all shadow-xl transform hover:-translate-y-1 flex items-center justify-center gap-2"
            >
              <svg
                className="w-5 h-5"
                fill="none"
